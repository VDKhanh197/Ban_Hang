  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Đăng kí</span> Khách hàng Laifude
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label> Xác nhận mật khẩu lần nữa </label>
...
<label> Danh bạ khách hàng </label>
...
echo "<script>alert('PVui lòng chọn Captcha, Thử lại')</script>";
