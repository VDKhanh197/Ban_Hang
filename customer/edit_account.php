...
<h1 align="center" > Sửa thông tin của bạn </h1>
...
<i class="fa fa-user-md" ></i> Lưu chỉnh sửa
...
echo "<script>alert('Thông tin tài khoản của bạn đã chỉnh sửa thành công, vui lòng đăng nhập lại!')</script>";
