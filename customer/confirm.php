...
<h1 align="center"> ui lòng xác nhận thanh toán của bạn </h1>
...
<option>Công Đoàn Phương Tây</option>
...
echo "<script>alert('Khoản thanh toán của bạn đã được nhận, đơn hàng sẽ được hoàn thành trong vòng 24 giờ')</script>";
