...
<i class="fa fa-dashboard"> </i> Sản phẩm chính
...
<i class="fa fa-money fa-fw"></i> Thêm sản phẩm chính
...
<label class="col-md-3 control-label" > Trang </label>
...
echo "<script>alert('Sản phẩm chính đã được thêm')</script>";
