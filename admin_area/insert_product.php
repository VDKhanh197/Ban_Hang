...
<i class="fa fa-money fa-fw"></i> Điền thông tin sản phẩm
...
Ví dụ Url sản phẩm : ao-gine-xanhduong
...
<label class="col-md-3 control-label" > Giá sản phẩm gốc </label>
...
<label class="col-md-3 control-label" > Giảm giá còn </label>
...
<label class="col-md-3 control-label" > Trang sản phẩm </label>
...
<a data-toggle="tab" href="#features"> Công dụng </a>

</li>

<li>

<a data-toggle="tab" href="#video"> Video sản phẩm </a>
