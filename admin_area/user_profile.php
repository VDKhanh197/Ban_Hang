...
<i class="fa fa-money fa-fw" ></i> Sửa hồ sơ quản trị viên
...
<input type="submit" name="update" value="Hoàn tất chỉnh sửa" class="btn btn-primary form-control">
...
echo "<script>alert('Chỉnh sửa thành công. Bạn cần đăng nhập lại.')</script>";
