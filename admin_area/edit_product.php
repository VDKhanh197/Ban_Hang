...
<i class="fa fa-money fa-fw"></i> Điền thông tin chỉnh sửa cho sản phẩm
...
<label class="col-md-3 control-label" > Từ khóa cho sản phẩm </label>
...
<a data-toggle="tab" href="#video"> Thêm video sản phẩm </a>
