...
<i class="fa fa-dashboard"></i> Nhà sản xuất
...
<i class="fa fa-money fa-fw"> </i> Sửa nhà sản xuất
...
<label class="col-md-3 control-label"> Hiển thị là nhà sản xuất hàng đầu </label>
...
<input type="submit" name="update" class="form-control btn btn-primary" value=" Lưu thay đổi " >
