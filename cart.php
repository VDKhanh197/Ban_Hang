...
<p class="text-muted" > Hiện tại bạn có <?php echo $count; ?> sản phẩm trong giỏ. </p>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Áp dụng" >
...
echo "<script>alert('Mã phiếu giảm giá của bạn đã được áp dụng')</script>";
...
$product_price = "<del> $pro_price VNĐ</del>";

$product_psp_price = "| $pro_psp_price VNĐ";
...
<p class="text-muted">
Chi phí vận chuyển và chi phí bổ sung được tính toán dựa trên giá trị bạn đã nhập.
</p>
